    ...
    if california == "YES":
        ...
        if exception == "NO":
            ...
            if birth_year >= 1993 and birth_month > 3 or birth_year > 1993:
                print("Sorry, you won't be able to consume any alcohol... anywhere...")
        if exception == "YES":
            if birth_year == 1993 and birth_month == 3 or birth_year <= 1993 and birth_month <= 3:
                print("It doesn't matter why you're consuming alcohol!\nYou can drink in the entire United States!\nCongrats!")
            if birth_year >= 1993 and birth_month > 3 or birth_year > 1993:
                print("You can consume alcohol in this way in the state of California.\nJust don't do it anywhere else.\nBecause that'd be illegal...")
        ...
        if kansas == "NO":
            ...
            if georgia_wisconsin == "YES":
                ...
                if exception_2 == "YES":
                    ...
                    if birth_year >= 1993 and birth_month > 3 or birth_year > 1993:
                        print("Cool-- you can legally consume alcohol in Wisconsin and Georgia.\nBut not in any other US state.\nSorry :(")
                if exception_2 == "NO":
                    if birth_year == 1993 and birth_month == 3 or birth_year <= 1993 and birth_month <= 3:
                        print("You can actively enjoy your alcohol in the ENTIRE United States!")
                        print("Congrats on your accomplishment!")
                    if birth_year >= 1993 and birth_month > 3 or birth_year > 1993:
                        print("I am sorry, you cannot legally consume alcohol in " +str(state_name)+ ".")
